<h2><a href="https://leetcode.com/problems/valid-number/?envType=problem-list-v2&envId=string">65. Valid Number</a></h2><h3>Hard</h3><hr><p>Given a string <code>s</code>, return whether <code>s</code> is a <strong>valid number</strong>.<br />
<br />
